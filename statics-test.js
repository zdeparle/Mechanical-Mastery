    ...
    if (needsImprovement.length > 0) {
        recommendations = needsImprovement.map(item => {
            ...
            return {
                ...
                tip: studyTips[item.category] || 'Review fundamental concepts and practice more problems in this area.'
            };
        });
    } else {
        recommendations.push({
            category: 'Overall',
            tip: 'Excellent work! Continue practicing advanced problems and consider exploring related topics like work-energy methods and impulse-momentum.'
        });
    }
